...
public class BusesController : ControllerBase
{
    ...
    public async Task<IActionResult> Delete(int id)
    {
        ...
        var assignments = _context.DriverAssignments.Where(a => a.BusId == id);
        _context.DriverAssignments.RemoveRange(assignments);
        var schedules = await _context.Schedules.Include(s => s.Tickets).Where(s => s.BusId == id).ToListAsync();
