...
public class RoutesController : ControllerBase
{
    ...
    public async Task<IActionResult> Delete(int id)
    {
        ...
        // Cascade: remove schedules (and their tickets) before deleting route
        var schedules = await _context.Schedules.Include(s => s.Tickets).Where(s => s.RouteId == id).ToListAsync();
        foreach (var s in schedules) _context.Tickets.RemoveRange(s.Tickets);
