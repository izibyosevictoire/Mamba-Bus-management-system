        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicencePhoto = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DriverAssignments_Buses_BusId",
                        column: x => x.BusId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassengerNameNormalized = table.Column<string>(type: "text", nullable: true),
                    PassengerGender = table.Column<string>(type: "text", nullable: true),
                    PassengerContact = table.Column<string>(type: "text", nullable: true),
                    ...
                    MomoPhone = table.Column<string>(type: "text", nullable: true),
                    ValidationToken = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DriverAssignments_BusId",
